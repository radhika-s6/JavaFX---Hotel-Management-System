...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    AddEmployee(){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/services.png"));
        Image i2 = i1.getImage().getScaledInstance(450, 450, Image.SCALE_DEFAULT);   //width, height
